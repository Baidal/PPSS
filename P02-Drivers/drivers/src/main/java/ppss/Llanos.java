...
public class Llanos {
    public Tramo buscarTramoLlanoMasLargo(ArrayList<Integer> lecturas) {
        ...
        if(lecturas.size() != 0 && lectura_anterior== lecturas.get(0)){ //En caso de que el primer elemento sea igual que "lectura_anterior", cambiamos el valor de esta variable para evitar bugs
            lectura_anterior--;
        }
