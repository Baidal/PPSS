...
public class ClienteDAO implements IClienteDAO {
    ...
    private final String password = "ppss";
    ...
    public void insert(Cliente cliente) throws SQLException {
        ...
        Connection connection = DriverManager.getConnection(cadena_conexionDB, user, "ppss");
    ...
    public void delete (Cliente cliente) throws SQLException {
        Connection connection = DriverManager.getConnection(cadena_conexionDB, user, password);
